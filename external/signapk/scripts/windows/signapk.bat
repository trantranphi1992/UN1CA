...
REM Locate signapk.jar in the directory where signapk.bat was found and start it.
...
REM By default, give signapk a max heap size of 1 gig and a stack size of 1meg.
...
REM followed by "value". signapk has been changed to know how to deal with that.
set params=
